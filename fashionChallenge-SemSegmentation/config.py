# My Config for the fashion problem
# 
...
class CustomConfigCOCO(Config):
    ...
    IMAGE_SIZE = 512 # submission masks size
    IMAGE_RESIZE_MODE = 'none' # done in preprocessing
    IMAGE_MIN_DIM = IMAGE_SIZE
    IMAGE_MAX_DIM = IMAGE_SIZE    
    
    NUM_CLASSES = 46 + 1 # plus background

    # Region Proposal Network 
    RPN_ANCHOR_SCALES = (16, 32, 64, 128, 256) # exclude 512 = image_size

    
class CustomConfigImageNet(CustomConfigCOCO):
    """
    My custom class using ImageNet pre-trained weights
    """
    # TODO
    WEIGHTS_PATH = 'mask_rcnn_coco.h5'
